...
cause of the issue and it was simple to implement a fix. In the case of this
...
resulting in the main function having an incorrect type which then triggered the
type check to fail on the main function.
...
fix the shortcomings of the previous one, thereby resolving the issue.
